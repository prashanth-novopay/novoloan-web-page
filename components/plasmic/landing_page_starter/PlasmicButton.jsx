...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: 62BHbKVWdcb_/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: se-qcKkSQhB-/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__bHygd)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__jyR27)}
                role={"img"}
              />
            ),
