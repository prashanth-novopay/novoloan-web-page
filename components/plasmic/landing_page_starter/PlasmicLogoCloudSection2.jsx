...
import * as sty from "./PlasmicLogoCloudSection2.module.css"; // plasmic-import: 8rwWf5hLrmzP/css
        ...
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__nHdo5)}
                role={"img"}
              ...
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img___72Mqy)}
                role={"img"}
              ...
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img___05Ldv)}
                role={"img"}
              ...
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__eonEe)}
                role={"img"}
              ...
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__niPgF)}
                role={"img"}
