...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: GIFaPeTXyJwJ/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__xt2X)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__ezmwp)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__hM864)}
              role={"img"}
            />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__eAubp)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__ns9Jw)}>
            {p.renderPlasmicSlot({
