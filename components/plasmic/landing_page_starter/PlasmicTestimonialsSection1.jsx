...
import * as sty from "./PlasmicTestimonialsSection1.module.css"; // plasmic-import: Tck-ZeuOe3l2/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__pHt1Q)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__io0Yw)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames(
                  "__wab_instance",
                  sty.testimonial___3Yk1R
                )}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__vvE1R)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__ks857)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img___5FdlU)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__iClQt)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__ucVpr)}
                    role={"img"}
                    src={
